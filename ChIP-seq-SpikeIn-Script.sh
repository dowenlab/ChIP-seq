#!/bin/bash
#SBATCH --job-name=ChIP-seq_Spike
#SBATCH --ntasks=1
#SBATCH --mem=32G
#SBATCH -N 1
#SBATCH -n 24	
#SBATCH --time=12:00:00
#SBATCH -e ChIP-seq_Spike.%job.err
...
Genome_DIR=/proj/dowenlab/projects/ChIP-seq/MergedGenomeforNormalization
chromSizes=/proj/dowenlab/projects/ChIP-seq/mm10.chrom.sizes
RepeatSequence=/proj/dowenlab/projects/ChIP-seq/RepeatSequence.bed

####### change below directory (DIR) before starting!!! #######
## NOTE: For replicates, merge the fastq files by doing cat file1.fastq file2.fastq before beginning this script. 
